...
<div id="top-bar" class="container">
		...
		<div id="wrapper" class="container">
			...
			<section class="main-content">
				<center>
			<div>
				<img src="admin/1.png" width="250px" height="100px">
		...
		<table align="center" >
			<tr>
				<td colspan = "3">
					<a href="shipprofile.jsp">
					    <button class="btn_dash"
							style="background-color: red; font-size: 40px; width: auto; height: 100px ">
							Shipping Management <br>
							<i class="fa fa-address-card"
								style="color: white; font-size: 70px; margin-top: 10px;  border-radius:20px; font-weight:bold"></i>
						</button>
					</a>
				</td>
				
				<td><a href="inventory.jsp"><button class="btn_dash"
							style="background-color: red;font-size: 40px; width: auto; height: 100px">
							Inventory Management <br>
							<i class="fa fa-bolt"
								style="color: white; font-size: 70px; margin-top: 50px;  border-radius:50px; font-weight:bold"></i>
						</button></a>
				</td>
				</tr>
				</table>
