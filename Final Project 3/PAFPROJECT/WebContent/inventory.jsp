				...
				<div class="span8">
					<div class="account pull-right">
						<ul class="user-menu">
							...
							<li><a href="admindashbord.jsp">Admin Dash-board</a></li>						
...
%>
                   ...
                   <tbody>
                    <tr>
                    <td><img width=80px height=50px  border="3" style = "border-color:  "src="<%=resultSet.getString("profilePic") %>"></td>
                       <td><%=resultSet.getString("productname") %></td>
                      <td><%=resultSet.getString("price") %></td>
                      <td><%=resultSet.getString("contactnumber") %></td>
                      <td><%=resultSet.getString("category") %></td>
                      
                     <td> <a href = "entry/post/generateUpdateForm?postid=<%=resultSet.getString("postid")%>">Update</a></td> 
                     <td> <a href = "entry/post/deactivate?postid=<%=resultSet.getString("postid")%>">Delete</a></td> 
