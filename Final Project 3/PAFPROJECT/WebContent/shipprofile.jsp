				...
				<div class="span8">
					<div class="account pull-right">
						<ul class="user-menu">
							...
							<li><a href="AddShip.jsp">Add Shipping Companies</a></li>
...
%>
                   ...
                   <tbody>
                    ...
                    <td><img width=80px height=50px  border="3" style = "border-color:  "src="<%=resultSet.getString("shippic") %>"></td>
                     ...
                     <td> <a href = "entry/ship/generateUpdateForm?shipid=<%=resultSet.getString("shipid")%>">Update</a></td> 
                     <td> <a href = "entry/ship/deactivate?shipid=<%=resultSet.getString("shipid")%>">Delete</a></td> 
